...
class StaticPageController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','announcement'),
				'users'=>array('@'),
			),
    ...
    public function actionAnnouncement($slug){
        $announcement = StaticPage::model()->findByAttributes(array('slug'=>$slug,'type'=>1,
            'static_type'=>'page','boolean'=>1));
        $this->render('announcement',array('model'=>$announcement));
    }
}
