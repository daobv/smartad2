        ...
        <div class="row content-site">
                        ...
                        <script type="text/javascript">
                            $('.reportrange').daterangepicker(
                                ...
                                function (start, end) {
                                    ...
                                    window.location.replace("<?php echo Yii::app()->createUrl('admin/index'); ?>?from="+start_date+"&&to="+end_date);
            ...
            <div>
                ...
                <div class="col-md-12"
                    ...
                    <h4 class="header-box-db" style="margin-top: 1px"><i class="fa fa-bar-chart-o"></i> THỐNG KÊ TOÀN HỆ THỐNG </h4>
