<div class="content">
    <div class="title"><h5>Quản Lý Bài Viết</h5>
        <div class="button" style="float:right">
            <?php echo CHtml::link(CHtml::button('Tạo mới'),Yii::app()->createUrl('admin/post/create')); ?>
        </div>
    </div>
    <div class="table">
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns'=>array(
        ...
        array(
            ...
            'header'=>'Type',
            'type'=>'raw',
            'value' => 'Category::model()->getCategoryNameById($data->static_category)',
